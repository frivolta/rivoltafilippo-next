export const site = {
  siteMetadata: {
    ...
    about: `Filippo Rivolta is a motivated front-end developer crafting rich User Experiences with minimal and aesthetically pleasing interfaces located in Milan, Italy.`,
